...
a Pro-level AI credit grant, to cap cost exposure during evaluation. Orgs with no plan and no
...
# Fallback AI credit grant for trial orgs if the Pro plan hasn't been seeded yet.
TRIAL_AI_CREDITS_FALLBACK = 1000
...
async def get_effective_access(db: AsyncSession, org: Organization) -> EffectiveAccess:
    ...
    if org.subscription_status == "trial":
        ...
        ai_credits = pro_plan.ai_credits_monthly if pro_plan else TRIAL_AI_CREDITS_FALLBACK
