"""Predefined industry-standard templates for Project Management module."""
        ...
        "tasks": [
            ...
            },
            {
                ...
                "subtasks": [
                    ...
                    {"title": "Scale to Target Capacity", "description": "Activate daily shift operations.", "start_offset_days": 55, "due_offset_days": 57, "priority": "high", "tags": [{"name": "production", "color": "#10B981"}]}
                ]
            }
        ]
    },
        ...
        "tasks": [
            {
                ...
                "subtasks": [
                    {"title": "Define Target Demographics", "description": "Outline target ages and jobs.", "start_offset_days": 0, "due_offset_days": 2, "priority": "low", "tags": [{"name": "personas", "color": "#64748B"}]},
                    {"title": "Select Core Platforms", "description": "Choose LinkedIn, Meta, or Google.", "start_offset_days": 2, "due_offset_days": 4, "priority": "medium", "tags": [{"name": "selection", "color": "#8B7CF6"}]}
                ]
            },
            {
