...
const Particles = () => {
    ...
    const uniforms = useMemo(() => ({
        ...
        uColorStart: { value: new THREE.Color('#7D8CF3') }, // Periwinkle blue
        uColorEnd: { value: new THREE.Color('#537CDE') }    // Deeper indigo blue
    }), []);
    ...
    const material = useMemo(() => new THREE.ShaderMaterial({
        ...
        fragmentShader: `
            ...
            void main() {
                ...
                // --- Dynamic Color Shifting (Periwinkle <-> Indigo brand tones) ---
                ...
                float mixAmt = clamp((p1 + p2) * 0.5 * 0.5 + 0.5, 0.0, 1.0);

                vec3 activeColor = mix(uColorStart, uColorEnd, mixAmt);
    ...
    useFrame((state) => {
        ...
        // Standard R3F pattern: mutate uniforms in place every frame instead
        // of recreating the material, so Three.js never re-allocates GPU state.
        // eslint-disable-next-line react-hooks/immutability -- intentional Three.js uniform mutation
