...
import type { CompanyStatus } from '../../../../models/crm/company';
import type { CRMOwnerOption } from '../../../../models/crm/owner';
import { COMPANY_STATUSES } from '../constants';

interface CompaniesBulkActionBarProps {
	selectedCount: number;
	owners: CRMOwnerOption[];
	loading: boolean;
	onReassign: (ownerId: number) => void;
	onChangeStatus: (status: CompanyStatus) => void;
	onDelete: () => void;
	onClear: () => void;
}

export const CompaniesBulkActionBar: React.FC<CompaniesBulkActionBarProps> = ({
	selectedCount,
	owners,
	loading,
	onReassign,
...
export default CompaniesBulkActionBar;
