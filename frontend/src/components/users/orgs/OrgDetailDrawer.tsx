					...
					<Box sx={{ flexGrow: 1, overflowY: 'auto', mx: -3, px: 3 }}>
						{selectedOrgUsersLoading ? (
							...
							<Box py={4} textAlign="center">
								<Typography variant="body2" color="error">{selectedOrgUsersError}</Typography>
							</Box>
											...
											<Box display="flex" gap={0.5}>
												{!user.is_verified && user.is_active && (
													<Tooltip title="Resend Invite">
														<IconButton size="small" color="primary" onClick={() => onUserAction(user, 'resendInvite')}>
												...
												<Tooltip title="Delete User">
													<IconButton size="small" color="error" onClick={() => onUserAction(user, 'delete')}>
