...
api.interceptors.response.use(
	...
	async (error) => {
		...
		try {
			...
			const publicPaths = ['/auth/', '/login', '/candidate-registration', '/success', '/maintenance', '/exam', '/meetings/manage', '/projects/status'];
			...
			const publicPaths = ['/auth/', '/login', '/candidate-registration', '/success', '/maintenance', '/exam', '/candidate/interview', '/meetings/manage', '/projects/status'];
			const isPublicPath = publicPaths.some(path => window.location.pathname.startsWith(path));
