...
api.interceptors.response.use(
	...
	async (error) => {
		...
		try {
			...
			const publicPaths = ['/auth/', '/login', '/candidate-registration', '/success', '/maintenance', '/exam', '/meetings/manage'];
			...
			const publicPaths = ['/auth/', '/login', '/candidate-registration', '/success', '/maintenance', '/exam', '/candidate/interview', '/meetings/manage'];
			const isPublicPath = publicPaths.some(path => window.location.pathname.startsWith(path));
